                    ...
                    <tr>
                        ...
                        <td class="border px-4 py-2">
                            <button wire:click="edit({{ $student->id }})"
                                class="flex px-2 py-2 rounded-md border border-transparent bg-gray-500 text-gray-900 cursor-pointer">Edit</button>
                            <button wire:click="delete({{ $student->id }})"
                                class="flex px-2 py-2 rounded-md border border-transparent bg-red-100 text-gray-900 cursor-pointer">Delete</button>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
